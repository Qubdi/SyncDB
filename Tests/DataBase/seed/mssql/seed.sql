-- ── Bootstrap ─────────────────────────────────────────────────────────────────
-- Creates the syncdb_test database and the admin/admin login used by the
-- SyncDB library and the data-check container. Runs idempotently via IF guards.
...
-- ── Seed Data ─────────────────────────────────────────────────────────────────
-- Row numbers are generated by cross-joining catalog views (sys.all_objects)
-- which is the idiomatic MSSQL alternative to generate_series.
